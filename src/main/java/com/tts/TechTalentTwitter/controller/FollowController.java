...
public class FollowController {
    ...
    //we'll first create the follow method, which will be callsed
    //whenever we amke a post request to /follow/{username}
    ...
    public String follow(@PathVariable(value="username")String username, HttpServletRequest request){
        ...
        //we save userToFollow to flush our changes to the database and redirect
        //to the last page.
